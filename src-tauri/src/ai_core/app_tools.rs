...
use tauri::Manager;
use crate::ai_core::local_tools::{get_str, get_str_opt, validate_path};
use crate::ai_core::tools::ToolError;

pub async fn set_theme(ctx: &dyn crate::ai_core::tools::ToolCtx, args: &serde_json::Value) -> Result<serde_json::Value, crate::ai_core::tools::ToolError> {
    let app = ctx.tauri_app_handle().ok_or_else(|| crate::ai_core::tools::ToolError::Exec("Requires GUI".into()))?;
...
pub async fn app_info(ctx: &dyn crate::ai_core::tools::ToolCtx, args: &serde_json::Value) -> Result<serde_json::Value, crate::ai_core::tools::ToolError> {
    let app = ctx.tauri_app_handle().ok_or_else(|| crate::ai_core::tools::ToolError::Exec("Requires GUI".into()))?;
    let state = app.state::<crate::provider_commands::ProviderState>();
    let app_state = app.state::<crate::AppState>();
    let context_local_path = ctx.context_local_path().map(|s| s.to_string());
...
pub async fn sync_control(ctx: &dyn crate::ai_core::tools::ToolCtx, args: &serde_json::Value) -> Result<serde_json::Value, crate::ai_core::tools::ToolError> {
    let app = ctx.tauri_app_handle().ok_or_else(|| crate::ai_core::tools::ToolError::Exec("Requires GUI".into()))?;
    let state = app.state::<crate::provider_commands::ProviderState>();
    let app_state = app.state::<crate::AppState>();
    let context_local_path = ctx.context_local_path().map(|s| s.to_string());
...
pub async fn vault_peek(ctx: &dyn crate::ai_core::tools::ToolCtx, args: &serde_json::Value) -> Result<serde_json::Value, crate::ai_core::tools::ToolError> {
    let app = ctx.tauri_app_handle().ok_or_else(|| crate::ai_core::tools::ToolError::Exec("Requires GUI".into()))?;
    let state = app.state::<crate::provider_commands::ProviderState>();
    let app_state = app.state::<crate::AppState>();
    let context_local_path = ctx.context_local_path().map(|s| s.to_string());
...
pub async fn cross_profile_transfer(ctx: &dyn crate::ai_core::tools::ToolCtx, args: &serde_json::Value) -> Result<serde_json::Value, crate::ai_core::tools::ToolError> {
    let app = ctx.tauri_app_handle().ok_or_else(|| crate::ai_core::tools::ToolError::Exec("Requires GUI".into()))?;
    let state = app.state::<crate::provider_commands::ProviderState>();
    let app_state = app.state::<crate::AppState>();
    let context_local_path = ctx.context_local_path().map(|s| s.to_string());
...
pub async fn preview_edit(ctx: &dyn crate::ai_core::tools::ToolCtx, args: &serde_json::Value) -> Result<serde_json::Value, crate::ai_core::tools::ToolError> {
    let app = ctx.tauri_app_handle().ok_or_else(|| crate::ai_core::tools::ToolError::Exec("Requires GUI".into()))?;
    let state = app.state::<crate::provider_commands::ProviderState>();
    let app_state = app.state::<crate::AppState>();
    let context_local_path = ctx.context_local_path().map(|s| s.to_string());
...
pub async fn hash_file(ctx: &dyn crate::ai_core::tools::ToolCtx, args: &serde_json::Value) -> Result<serde_json::Value, crate::ai_core::tools::ToolError> {
    let app = ctx.tauri_app_handle().ok_or_else(|| crate::ai_core::tools::ToolError::Exec("Requires GUI".into()))?;
    let state = app.state::<crate::provider_commands::ProviderState>();
    let app_state = app.state::<crate::AppState>();
    let context_local_path = ctx.context_local_path().map(|s| s.to_string());
...
pub async fn generate_transfer_plan(ctx: &dyn crate::ai_core::tools::ToolCtx, args: &serde_json::Value) -> Result<serde_json::Value, crate::ai_core::tools::ToolError> {
    let app = ctx.tauri_app_handle().ok_or_else(|| crate::ai_core::tools::ToolError::Exec("Requires GUI".into()))?;
    let state = app.state::<crate::provider_commands::ProviderState>();
    let app_state = app.state::<crate::AppState>();
    let context_local_path = ctx.context_local_path().map(|s| s.to_string());
...
pub async fn upload_files(ctx: &dyn crate::ai_core::tools::ToolCtx, args: &serde_json::Value) -> Result<serde_json::Value, crate::ai_core::tools::ToolError> {
    let app = ctx.tauri_app_handle().ok_or_else(|| crate::ai_core::tools::ToolError::Exec("Requires GUI".into()))?;
    let state = app.state::<crate::provider_commands::ProviderState>();
    let app_state = app.state::<crate::AppState>();
    let context_local_path = ctx.context_local_path().map(|s| s.to_string());
...
pub async fn download_files(ctx: &dyn crate::ai_core::tools::ToolCtx, args: &serde_json::Value) -> Result<serde_json::Value, crate::ai_core::tools::ToolError> {
    let app = ctx.tauri_app_handle().ok_or_else(|| crate::ai_core::tools::ToolError::Exec("Requires GUI".into()))?;
    let state = app.state::<crate::provider_commands::ProviderState>();
    let app_state = app.state::<crate::AppState>();
    let context_local_path = ctx.context_local_path().map(|s| s.to_string());
...
pub async fn sync_preview(ctx: &dyn crate::ai_core::tools::ToolCtx, args: &serde_json::Value) -> Result<serde_json::Value, crate::ai_core::tools::ToolError> {
    let app = ctx.tauri_app_handle().ok_or_else(|| crate::ai_core::tools::ToolError::Exec("Requires GUI".into()))?;
    let state = app.state::<crate::provider_commands::ProviderState>();
    let app_state = app.state::<crate::AppState>();
    let context_local_path = ctx.context_local_path().map(|s| s.to_string());
...
pub async fn remote_edit(ctx: &dyn crate::ai_core::tools::ToolCtx, args: &serde_json::Value) -> Result<serde_json::Value, crate::ai_core::tools::ToolError> {
    let app = ctx.tauri_app_handle().ok_or_else(|| crate::ai_core::tools::ToolError::Exec("Requires GUI".into()))?;
    let state = app.state::<crate::provider_commands::ProviderState>();
    let app_state = app.state::<crate::AppState>();
    let context_local_path = ctx.context_local_path().map(|s| s.to_string());
