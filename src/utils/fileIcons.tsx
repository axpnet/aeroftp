/**
 * File icon utilities - maps file extensions to icons and colors
 */
 ...
 */
export const getFileIcon = (filename: string, size: number = 16): FileIconResult => {
...
/**
 * Get only the color for a file (legacy compatibility)
 */
