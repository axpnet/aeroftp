...
const DependenciesPanel: React.FC<DependenciesPanelProps> = ({ isVisible, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-[720px] max-h-[80vh] flex flex-col border border-gray-200 dark:border-gray-700 animate-scale-in">
                {/* Header */}
