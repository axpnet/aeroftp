...
const THEMES = {
    ...
    dark: {
        ...
        operation: {
            ...
            PROFILE_SAVE: 'text-blue-400',
            PROFILE_DUPLICATE: 'text-amber-400',
        },
        operationGlow: {
            CONNECT: '', DISCONNECT: '', UPLOAD: '', DOWNLOAD: '',
            DELETE: '', RENAME: '', MOVE: '', MKDIR: '', NAVIGATE: '', UPDATE: '',
    ...
    tokyo: {
        ...
        operation: {
            ...
            SUCCESS: 'text-[#9ece6a]',
            RESTORE: 'text-[#73daca]',
            PROFILE_SAVE: 'text-[#7aa2f7]',
            PROFILE_DUPLICATE: 'text-[#e0af68]',
        },
        operationGlow: {
            CONNECT: '', DISCONNECT: '', UPLOAD: '', DOWNLOAD: '',
            DELETE: '', RENAME: '', MOVE: '', MKDIR: '', NAVIGATE: '', UPDATE: '',
    ...
    cyber: {
        ...
        operationGlow: {
            ...
            PROFILE_SAVE: 'drop-shadow-[0_0_6px_rgba(34,211,238,0.6)]',
            PROFILE_DUPLICATE: 'drop-shadow-[0_0_6px_rgba(251,191,36,0.8)]',
        },
