...
export const QuickLookOverlay: React.FC<QuickLookOverlayProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-gray-900 rounded-lg shadow-2xl border border-gray-700/50 w-[80vw] max-w-4xl h-[80vh] max-h-[800px] flex flex-col overflow-hidden animate-scale-in"
